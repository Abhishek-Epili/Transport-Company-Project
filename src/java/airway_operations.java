...
public class airway_operations extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try ( PrintWriter out = response.getWriter()) {
            ...
            comp = request.getParameter("class");
            ...
            session.setAttribute("air_source",source);
            session.setAttribute("air_end",end);
            session.setAttribute("air_comp",comp);
            session.setAttribute("air_person",person);
            session.setAttribute("air_price",price);
            session.setAttribute("air_date",date);
            session.setAttribute("air_takeoff",takeoff_time);
            session.setAttribute("air_land",land_time);
            session.setAttribute("air_seat",seat_no);
            System.out.println(session.getAttribute("air_source"));
...
"        <script src=\"navbar.js\"></script>");
            ...
            out.println("<h1 style='position: relative; top:100px; left:50px;'>Flight Available on "+date+"</h1>");
            ...
            out.print("<tr><td>"+source+"</td><td>"+end+"</td><td>"+takeoff_time+"</td><td>"+land_time+"</td><td>"+comp+"</td><td>"+date+"</td><td><a href='air_confirm'>Book</a></td></tr>");
            out.println("</table>");
            out.println("</body>");
            out.println("</html>");
        }
